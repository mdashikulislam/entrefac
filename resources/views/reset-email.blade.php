                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('password.email') }}" method="post">
                            ...
                            <div class="input-group mb-3">
                                <input  required autocomplete="email" autofocus name="email" type="email" class="form-control  @error('email') is-invalid @enderror" placeholder="Email">
                            ...
                            <div class="social-auth-links text-center mt-2 mb-3">
                                <button type="submit" class="btn btn-block btn-primary">
                                    <i class="fas fa-unlock-alt mr-2"></i> {{ __('Send Password Reset Link') }}
                                </button>
                            </div>
                        </form>
                    </div>
